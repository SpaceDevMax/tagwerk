// In widgets/task_tile.dart, update TaskTile class
...
class TaskTile extends StatelessWidget {
  ...
  Future<Color?> getTaskColor(int? groupId) async {
    if (groupId == null) return null;
    final group = await todoService.getGroupById(groupId);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Color?>(
      future: getTaskColor(todo.groupId),
      builder: (context, snapshot) {
        final taskColor = snapshot.data;
            ...
            children: [
              ...
              Checkbox(
                ...
                onChanged: (value) async {
                  ...
                  if (newIsDone && subtasks.isNotEmpty && !(await todoService.areAllSubtasksDone(todoId))) {
                    ...
                    if (confirm == true) {
                      await todoService.markAllSubtasksDone(todoId);
                      await todoService.updateIsDone(todoId, true);
                    }
                  } else {
                    await todoService.updateIsDone(todoId, newIsDone);
                  }
                },
              ),
            ],
          ...
          trailing: Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () async {
                  await todoService.toggleDueToday(todoId);
                },
              ),
              IconButton(
                ...
                onPressed: () {
                  ...
                  TaskDialog(
                    ...
                    onSave: (title, description, dueDate, groupId, subtasks) async {
                      await todoService.editTask(todoId, title, description, dueDate, subtasks, groupId);
                    },
          ...
          children: [
            ...todo.subtasks.asMap().entries.map((entry) {
              ...
              return ListTile(
                ...
                leading: Checkbox(
                  value: sub.isDone,
                  onChanged: (subValue) async {
                    final newSubDone = subValue ?? false;
                    await todoService.toggleSubtask(todoId, subIdx, newSubDone);
                    if (newSubDone && await todoService.areAllSubtasksDone(todoId) && !todo.isDone) {
                      await todoService.updateIsDone(todoId, true);
                    }
                  },
                ),
                ...
                showDialog(
                  ...
                  builder: (dialogContext) => AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                        onPressed: () async {
                          await todoService.addSubtask(todoId, subController.text);
